...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: No defects found in TakingTurnsQueue logic for this scenario.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson() fails to re-enqueue people with 0 turns. The logic only checks for turns > 1.
    ...
    // Defect(s) Found: GetNextPerson() fails to re-enqueue people with negative turns.
    ...
    // Defect(s) Found: No defects found. The system correctly throws an InvalidOperationException.
